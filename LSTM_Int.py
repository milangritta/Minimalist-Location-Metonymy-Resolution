...
model_left.add(Embedding(len(vocabulary), dimensionality, input_length=seq_length))
...
model_right.add(Embedding(len(vocabulary), dimensionality, input_length=seq_length))
